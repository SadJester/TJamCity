...
TEST_F(WorldCreatorTests, CreateEdge_MergingLanes_2x2_to_4) {
    ...
    Edge& right_merge_edge = network.edges[3];
    Edge& left_merge_edge = network.edges[0];
    Edge& out_edge = network.edges[1];
...
TEST_F(WorldCreatorTests, CreateEdge_Straight_4x4) {
    ...
    Edge& in_edge = network.edges[1];
    Edge& out_edge = network.edges[2];
...
TEST_F(WorldCreatorTests, DISABLED_CreateEdge_4_to_3) {
