...
TEST_F(VehicleMovementModuleTest, NoMovementWhenCurrentGoalIsNullptr) {
	...
	EXPECT_EQ(agent.vehicle->coordinates.latitude, initialPosition.latitude);
	EXPECT_EQ(agent.vehicle->coordinates.longitude, initialPosition.longitude);
...
TEST_F(VehicleMovementModuleTest, MovementOccursWithValidGoalAndLane) {
	...
	EXPECT_NE(agent.vehicle->coordinates.latitude, initialPosition.latitude);
	EXPECT_NE(agent.vehicle->coordinates.longitude, initialPosition.longitude);
...
TEST_F(VehicleMovementModuleTest, MultipleAgentsWithDifferentStates) {
	...
	EXPECT_NE(agent1.vehicle->coordinates.latitude, initialPos1.latitude);
	EXPECT_NE(agent1.vehicle->coordinates.longitude, initialPos1.longitude);
	EXPECT_EQ(agent2.vehicle->coordinates.latitude, initialPos2.latitude);
	EXPECT_EQ(agent2.vehicle->coordinates.longitude, initialPos2.longitude);
}
